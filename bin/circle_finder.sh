...
awk '$1==$10 && $7==$16 && $6>0 && $15>0 {print $4} ' ${sample_id}.split_freq2.oneline.txt > ${sample_id}.split_freq2.oneline.S-R-S-CHR-S-ST.ID.txt

cat "${sample_id}.split_freq2.oneline.S-R-S-CHR-S-ST.ID.txt"
echo ""
cat "${sample_id}.concordant_freq3.txt"
